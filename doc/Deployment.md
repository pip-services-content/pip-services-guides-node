...
The Guides microservice can also be used as a Seneca plugin.
...
var plugin = require('pip-services-guides-node').GuidesSenecaPlugin;
...
or by using [GuidesSenecaClient](https://github.com/pip-services/pip-clients-guides-node/NodeClientApiV1.md/#client_seneca)