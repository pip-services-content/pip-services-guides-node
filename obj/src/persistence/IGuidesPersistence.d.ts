...
export interface IGuidesPersistence extends IGetter<GuideV1, string>, IWriter<GuideV1, string> {
    ...
    getOneById(correlationId: string, id: string, callback: (err: any, item: GuideV1) => void): void;
    create(correlationId: string, item: GuideV1, callback: (err: any, item: GuideV1) => void): void;
    update(correlationId: string, item: GuideV1, callback: (err: any, item: GuideV1) => void): void;
    deleteById(correlationId: string, id: string, callback: (err: any, item: GuideV1) => void): void;
}
