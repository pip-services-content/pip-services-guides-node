...
class GuidesCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetGuidesCommand() {
        return new pip_services3_commons_node_2.Command("get_guides", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetRandomGuideCommand() {
        return new pip_services3_commons_node_2.Command("get_random_guide", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetGuideByIdCommand() {
        return new pip_services3_commons_node_2.Command("get_guide_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('guide_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeCreateGuideCommand() {
        return new pip_services3_commons_node_2.Command("create_guide", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateGuideCommand() {
        return new pip_services3_commons_node_2.Command("update_guide", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('guide', new GuideV1Schema_1.GuideV1Schema()), (correlationId, args, callback) => {
            let guide = args.get("guide");
    ...
    makeDeleteGuideByIdCommand() {
        return new pip_services3_commons_node_2.Command("delete_guide_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('guide_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let guideId = args.getAsNullableString("guide_id");
