...
class GuideV1Schema extends pip_services3_commons_node_1.ObjectSchema {
    constructor() {
        super();
        /* Identification */
        ...
        this.withOptionalProperty('app', pip_services3_commons_node_3.TypeCode.String);
        ...
        /* Content */
        this.withOptionalProperty('pages', new pip_services3_commons_node_2.ArraySchema(new GuidePageV1Schema_1.GuidePageV1Schema()));
        /* Search */
